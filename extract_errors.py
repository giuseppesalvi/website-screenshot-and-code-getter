...
import pprint
# ERRORS_TO_AGGREGATE = [
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by ", "Failed to establish a new connection: [Errno -5] No address associated with hostname'))"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by SSLError", "doesn't match either of"],
    # ["Message: element click intercepted: Element is not clickable at point"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by SSLError(CertificateError","doesn't match"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by SSLError(SSLCertVerificationError", "certificate verify failed: certificate has expired"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by SSLError(CertificateError(" + "hostname" + "doesn't match"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by NewConnectionError", "Failed to establish a new connection:", "No route to host"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by NewConnectionError", "Failed to establish a new connection", "Temporary failure in name resolution"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by ConnectTimeoutError", "Connection to", "timed out."],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by NewConnectionError", "Failed to establish a new connection", "Connection refused"],
    # ["HTTPSConnectionPool" ,"Max retries exceeded with url: / (Caused by SSLError(SSLCertVerificationError", "certificate verify failed: self signed certificate"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by NewConnectionError", "Failed to establish a new connection", "Connection refused"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by SSLError(SSLCertVerificationError", "certificate verify failed: unable to get local issuer certificate"],
    # ["Message: element click intercepted: Element", "is not clickable at point", "Other element would receive the click:"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by NewConnectionError", "Failed to establish a new connection", "Name or service not known"],
    # ["HTTPConnectionPool", "Read timed out. (read timeout=5)"],
    # ["Message: timeout: Timed out receiving message from renderer"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by SSLError", "wrong version number"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by SSLError", "alert internal error"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by SSLError", "alert handshake failure"],
    # ["Command 'clean-html", "returned non-zero exit status 1"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url:", "Caused by NewConnectionError", "Failed to establish a new connection:", "Temporary failure in name resolution"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url:", "Caused by NewConnectionError", "Failed to establish a new connection:", "Name or service not known"],
    # ["Message: element click intercepted"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url: / (Caused by SSLError", "unrecognized name"],
    # ["HTTPSConnectionPool", "Read timed out."],
    # ["Failed to parse:", "label empty or too long"],
    # ["Connection aborted.", "Transport endpoint is not connected"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url:", "Caused by NewConnectionError","Failed to establish a new connection","Connection timed out"],
    # ["HTTPConnectionPool", "Max retries exceeded with url: / (Caused by NewConnectionError", "Failed to establish a new connection", "Connection refused"],
    # ["HTTPConnectionPool", "Read timed out"],
    # ["HTTPConnectionPool", "Max retries exceeded with url: / (Caused by NewConnectionError", "Failed to establish a new connection", "Temporary failure in name resolution"],
    # ["HTTPSConnectionPool", "Max retries exceeded with url", "(Caused by SSLError", "certificate verify failed: certificate has expired"],
    # ["HTTPConnectionPool", "Max retries exceeded with url: / (Caused by NewConnectionError", "Failed to establish a new connection", "No address associated with hostname"],
    ...
    # ["HTTPConnectionPool", "Max retries exceeded with url:", "Caused by NewConnectionError", "Failed to establish a new connection", "Name or service not known"]
# ]
ERRORS_TO_AGGREGATE = [
    ["Message: element click intercepted: Element", "is not clickable at point"],
    ["Message: timeout: Timed out receiving message from renderer"],
